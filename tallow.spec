...
Version  : 14
Release  : 22
URL      : https://github.com/clearlinux/tallow/releases/download/v14/tallow-14.tar.gz
Source0  : https://github.com/clearlinux/tallow/releases/download/v14/tallow-14.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-3.0
Requires: tallow-autostart = %{version}-%{release}
Requires: tallow-bin = %{version}-%{release}
Requires: tallow-config = %{version}-%{release}
...
export LANG=C
export SOURCE_DATE_EPOCH=1538678434
export AR=gcc-ar
