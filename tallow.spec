...
Source0  : https://github.com/clearlinux/tallow/releases/download/v19/tallow-19.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572906081
...
cp %{_builddir}/tallow-19/COPYING %{buildroot}/usr/share/package-licenses/tallow/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
