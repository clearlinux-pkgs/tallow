...
Source0  : https://github.com/clearlinux/tallow/releases/download/v20/tallow-20.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581619794
...
cp %{_builddir}/tallow-20/COPYING %{buildroot}/usr/share/package-licenses/tallow/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
